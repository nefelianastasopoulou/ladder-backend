...
const { sanitize, validateContentLength, validateRequest } = require('./backend/middleware/validation');
const apiDocumentation = require('./backend/docs/api-docs');
const { metricsMiddleware, errorMetricsMiddleware, metricsCollector } = require('./backend/utils/metrics');
